...
# Add this near the top of your script, after other global variables
tracked_cars = {i: {"green_zone_order": [], "green_zone_times": {}} for i in range(50)}
...
class Car:
    ...
    def update(self, map, generation_start_time):
        ...
        if self.visited_green_zone_count == 4 and not hasattr(self, 'visited_all_four'):
